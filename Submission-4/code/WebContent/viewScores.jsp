...
<%
	Database.connect();
	ResultSet rs=Database.runQuery("select distinct id from scores order by id asc");
...
<% 
	...
	{
		Database.connect();
		rs=Database.runQuery("select * from scores where id="+eventID+ " order by position");
