...
<%
	...
	{
		Database.connect();
		rs=Database.runQuery("select participant from participants where eventID="+id+",hostelName='"+(String)(session.getAttribute("user"))+"'");
%>
		<table>
		<tr>
		<th>Participants</th>
