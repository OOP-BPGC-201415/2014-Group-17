...
/**
 * Servlet implementation class AddingScoresServlet
 */
@WebServlet("/AddingScoresServlet")
public class AddingScoresServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<font color=red><b>Scores have been added.</b></font><br/><br/>");
		dispatcher.include(request, response);
		
		}
		else
		{
			RequestDispatcher rd = getServletContext().getRequestDispatcher("/addScores.jsp");
	        PrintWriter out= response.getWriter();
	        out.println("<font color=red><b>One of the winners is not a participant or scores already addedt</b></font><br/><br/>");
